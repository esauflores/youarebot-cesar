# %% [markdown]
# Experiment 7: ModernBERT + DoRA (with features)
# DoRA on ModernBERT-base, dialog + numeric prefix — minimize log loss
...
# %%
with mlflow.start_run(run_name="modernbert-dora-feats"):
    mlflow.log_params({
        "model": MODEL_NAME,
    ...
    mlflow.set_tag("notes", "DoRA on ModernBERT-base, dialog context WITH numeric feature prefix.")
