# %% [markdown]
# Experiment: ModernBERT Full Fine-Tune
...
# %%
with mlflow.start_run(run_name="modernbert-full-finetune"):
    mlflow.log_params({
        "model": MODEL_NAME,
    ...
    mlflow.set_tag("notes", "Full fine-tuning of ModernBERT-base, no LoRA. Dialog context + numeric features.")
